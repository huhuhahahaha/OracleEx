...
SELECT FIRST_NAME AS NAME, SALARY AS 급여, SALARY + 300 AS 인상된급여 FROM EMPLOYEES;
...
SELECT first_name || ' ' || LAST_NAME || ' 사원의 급여는 ' || SALARY || '달러 입니다.' SALARY FROM EMPLOYEES WHERE first_name = 'Steven' AND LAST_NAME = 'King';
