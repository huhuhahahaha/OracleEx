...
SELECT FIRST_NAME, SYSDATE - HIRE_DATE FROM EMPLOYEES; --DAY
...
--날짜의 반올림, 절삭(많이 쓸 일은 없음)
SELECT ROUND(SYSDATE), TRUNC(SYSDATE) FROM DUAL; -- ROUND는 12시 기준으로 반올림, TRUNC는 일자기준으로 절삭 계산
